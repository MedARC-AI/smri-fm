...
- [eval-interface-is-nifti-in](eval-interface-is-nifti-in.md) — why the per-nifti contract exists, and the batching it costs.
- [seg-probe-design](seg-probe-design.md) — repeated CV, two embed passes for the memory bound, still untuned.
